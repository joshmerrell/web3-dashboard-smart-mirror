...
export const sunriseAt = hasError?"":new Date(weatherData.sys.sunrise).toLocaleTimeString();
export const sunsetAt = hasError?"":new Date(weatherData.sys.sunset).toLocaleTimeString();
